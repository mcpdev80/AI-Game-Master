...
func registerRoutes(router *gin.Engine, handler *Handler, cfg Config) {
	...
	router.GET("/api/sessions/:id/companions", handler.listSessionCompanions)
	...
	router.POST("/api/sessions/:id/companions", handler.createSessionCompanion)
	router.PUT("/api/session-companions/:companionId", handler.updateSessionCompanion)
	router.DELETE("/api/session-companions/:companionId", handler.deleteSessionCompanion)
