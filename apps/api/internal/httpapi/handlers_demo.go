	...
	return []Character{
		{
			...
			Metadata: baseMetadata(map[string]any{
				...
				"feature_notes":              "Lay on Hands: Healing pool of 5 HP per long rest that can restore wounds or cure one disease or poison by spending 5 HP.\nDivine Sense: As an action, detect celestials, fiends, undead, and consecrated or desecrated places within 60 ft.\nHoly Resolve: Demo flavor trait that reinforces her steady battlefield presence.",
		...
		},
		{
			...
			Metadata: baseMetadata(map[string]any{
				...
				"feature_notes":              "Sneak Attack: Once per turn add 1d6 damage when you have advantage or an ally is engaging the target.\nExpertise: Double proficiency bonus on two key skills for scouting and infiltration.\nHalfling Nimbleness: Move through spaces occupied by larger creatures when positioning in tight terrain.",
		...
		},
		{
			...
			Metadata: baseMetadata(map[string]any{
				...
				"feature_notes":              "Disciple of Life: Healing spells restore extra hit points based on spell level.\nLife Domain: Broadens healing support and reinforces his role as party protector.\nSpellcasting: Uses Wisdom for cleric spells and support magic.",
		...
		},
		{
			...
			Metadata: baseMetadata(map[string]any{
				...
				"feature_notes":              "Arcane Recovery: Recover spent spell energy once per day after a short rest.\nSpellcasting: Uses Intelligence for wizard spells and magical problem-solving.\nCantrip Training: Reliable at-will magic for damage, utility, and exploration.",
